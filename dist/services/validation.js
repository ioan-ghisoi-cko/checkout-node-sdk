...
exports.setSourceType = exports.setTokenType = exports.setSourceOrDestinationType = exports.validatePayment = void 0;
...
var setSourceType = function setSourceType(request) {
  if (request.type) {
    return request;
  } else if ("source_data" in request && "account_type" in request.source_data) {
    request.type = "ach";
