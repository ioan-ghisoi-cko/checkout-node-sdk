    ...
    nock("https://api.sandbox.checkout.com")
      ...
      .reply(201, {
        ...
        destination: {
          ...
          last4: "4242",
          fingerprint:
            "D3E048C1E888DD2903D37A8EB3BFAC60674754BEE23A3B1C4CF3B8D6D7FFD146",
          bin: "424242",
          card_type: "Credit",
          card_category: "Consumer",
          issuer: "JPMORGAN CHASE BANK NA",
    ...
    nock("https://api.sandbox.checkout.com")
      ...
      .reply(201, {
        ...
        source: {
          ...
          last4: "4242",
          fingerprint:
            "35D40AFFDC82BCAC9890181E14655B05D8924C0B4986D29F99D13946A3B59513",
          bin: "424242",
          card_type: "Credit",
          card_category: "Consumer",
          issuer: "JPMORGAN CHASE BANK NA",
